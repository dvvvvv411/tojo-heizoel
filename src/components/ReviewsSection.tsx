  ...
  const reviews = [
    {
      ...
      location: 'Berlin',
      rating: 5,
      text: 'Bereits zum dritten Mal bestellt und immer top zufrieden! Pünktliche Lieferung, faire Preise und sehr freundlicher Service. Kann Tojo Heizöl nur weiterempfehlen!',
      date: '2026-01-15'
    },
    {
      name: 'Thomas W.',
    ...
    },
    {
      ...
      location: 'Leipzig',
      rating: 5,
      text: 'Beste Heizölpreise in der Region! Habe verschiedene Anbieter verglichen und Tojo Heizöl war nicht nur günstiger, sondern auch noch serviceorientierter.',
      date: '2025-12-05'
    }
  ];
