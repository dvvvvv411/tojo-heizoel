          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative flex items-center justify-center">
              <div className="premium-card rounded-3xl p-12 text-center w-full max-w-md">
                ...
                <h3 className="text-3xl font-bold text-gray-900 mb-2">Tojo Heizöl</h3>
                <p className="text-xl text-primary-600 font-semibold mb-6">ToJo Verwaltungs GmbH</p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              Warum <span className="gradient-text-premium">Tojo Heizöl</span> wählen?
            </h2>
